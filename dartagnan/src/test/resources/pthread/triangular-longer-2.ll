; ModuleID = 'triangular-longer-2.c'
source_filename = "triangular-longer-2.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-pc-linux-gnu"

@.str = private unnamed_addr constant [2 x i8] c"0\00", align 1
@.str.1 = private unnamed_addr constant [22 x i8] c"triangular-longer-2.c\00", align 1
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 {
  ...
  %13 = icmp sge i32 %12, 26
  %14 = zext i1 %13 to i32
  store i32 %14, ptr %8, align 4
  call void (...) @__VERIFIER_atomic_end()
  call void (...) @__VERIFIER_atomic_begin()
  %15 = load i32, ptr @j, align 4
  %16 = icmp sge i32 %15, 26
